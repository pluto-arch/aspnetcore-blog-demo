...
namespace Pluto.BlogCore.Application.Behaviors
{
    ...
    public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        ...
        public TransactionBehaviour(ILogger<TransactionBehaviour<TRequest, TResponse>> logger, EventIdProvider eventIdProvider, IUnitOfWork<PlutoBlogCoreDbContext> unitOfWork)
        {
            _logger = logger;
